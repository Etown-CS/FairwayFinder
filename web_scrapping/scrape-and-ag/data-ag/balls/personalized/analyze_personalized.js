...
const filePaths = [
  "../../../web-src-scraping/balls/personalized/" + names.balls.personalized["tgw.com"] + '.txt',
  "../../../web-src-scraping/balls/personalized/" + names.balls.personalized["rockbottomgolf.com"] + '.txt',
  "../../../web-src-scraping/balls/personalized/" + names.balls.personalized["globalgolf.com"] + '.txt',
  "../../../web-src-scraping/balls/personalized/" + names.balls.personalized["pgatoursuperstore.com"] + '.txt',
  "../../../web-src-scraping/balls/personalized/" + names.balls.personalized["golfdiscount.com"] + '.txt',
  "../../../web-src-scraping/balls/personalized/" + names.balls.personalized["carlsgolfland.com"] + '.txt',
  "../../../web-src-scraping/balls/personalized/" + names.balls.personalized["dickssportinggoods.com"] + '.txt'
];
