...
const filePaths = [
  "../../../web-src-scraping/clubs/drivers/" + data.clubs.drivers["tgw.com"] + '.txt',
  "../../../web-src-scraping/clubs/drivers/" + data.clubs.drivers["rockbottomgolf.com"] + '.txt',
  "../../../web-src-scraping/clubs/drivers/" + data.clubs.drivers["globalgolf.com"] + '.txt',
  "../../../web-src-scraping/clubs/drivers/" + data.clubs.drivers["pgatoursuperstore.com"],
  "../../../web-src-scraping/clubs/drivers/" + data.clubs.drivers["golfdiscount.com"] + '.txt',
  "../../../web-src-scraping/clubs/drivers/" + data.clubs.drivers["carlsgolfland.com"] + '.txt',
  "../../../web-src-scraping/clubs/drivers/" + data.clubs.drivers["dickssportinggoods.com"] + '.txt'
];
