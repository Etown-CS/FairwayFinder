...
const filePaths = [
  "../../../web-src-scraping/clubs/drivers/" + names.clubs.drivers["tgw.com"] + '.txt',
  "../../../web-src-scraping/clubs/drivers/" + names.clubs.drivers["rockbottomgolf.com"] + '.txt',
  "../../../web-src-scraping/clubs/drivers/" + names.clubs.drivers["globalgolf.com"] + '.txt',
  "../../../web-src-scraping/clubs/drivers/" + names.clubs.drivers["pgatoursuperstore.com"] + '.txt',
  "../../../web-src-scraping/clubs/drivers/" + names.clubs.drivers["golfdiscount.com"] + '.txt',
  "../../../web-src-scraping/clubs/drivers/" + names.clubs.drivers["carlsgolfland.com"] + '.txt',
  "../../../web-src-scraping/clubs/drivers/" + names.clubs.drivers["dickssportinggoods.com"] + '.txt'
];
