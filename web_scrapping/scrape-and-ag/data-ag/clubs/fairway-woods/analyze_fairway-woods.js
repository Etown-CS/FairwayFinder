...
const filePaths = [
  "../../../web-src-scraping/clubs/fairway-woods/" + names.clubs["fairway-woods"]["tgw.com"] + '.txt',
  "../../../web-src-scraping/clubs/fairway-woods/" + names.clubs["fairway-woods"]["rockbottomgolf.com"] + '.txt',
  "../../../web-src-scraping/clubs/fairway-woods/" + names.clubs["fairway-woods"]["globalgolf.com"] + '.txt',
  "../../../web-src-scraping/clubs/fairway-woods/" + names.clubs["fairway-woods"]["pgatoursuperstore.com"] + '.txt',
  "../../../web-src-scraping/clubs/fairway-woods/" + names.clubs["fairway-woods"]["golfdiscount.com"] + '.txt',
  "../../../web-src-scraping/clubs/fairway-woods/" + names.clubs["fairway-woods"]["carlsgolfland.com"] + '.txt',
  "../../../web-src-scraping/clubs/fairway-woods/" + names.clubs["fairway-woods"]["dickssportinggoods.com"] + '.txt'
];
