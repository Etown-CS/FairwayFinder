...
const filePaths = [
  "../../../web-src-scraping/clubs/irons/" + names.clubs.irons["tgw.com"] + '.txt',
  "../../../web-src-scraping/clubs/irons/" + names.clubs.irons["rockbottomgolf.com"] + '.txt',
  "../../../web-src-scraping/clubs/irons/" + names.clubs.irons["globalgolf.com"] + '.txt',
  "../../../web-src-scraping/clubs/irons/" + names.clubs.irons["pgatoursuperstore.com"] + '.txt',
  "../../../web-src-scraping/clubs/irons/" + names.clubs.irons["golfdiscount.com"] + '.txt',
  "../../../web-src-scraping/clubs/irons/" + names.clubs.irons["carlsgolfland.com"] + '.txt',
  "../../../web-src-scraping/clubs/irons/" + names.clubs.irons["dickssportinggoods.com"] + '.txt'
];
