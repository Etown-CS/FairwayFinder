...
const filePaths = [
  "../../../web-src-scraping/clubs/irons/" + data.clubs.irons["tgw.com"] + '.txt',
  "../../../web-src-scraping/clubs/irons/" + data.clubs.irons["rockbottomgolf.com"] + '.txt',
  "../../../web-src-scraping/clubs/irons/" + data.clubs.irons["globalgolf.com"] + '.txt',
  "../../../web-src-scraping/clubs/irons/" + data.clubs.irons["pgatoursuperstore.com"] + '.txt',
  "../../../web-src-scraping/clubs/irons/" + data.clubs.irons["golfdiscount.com"] + '.txt',
  "../../../web-src-scraping/clubs/irons/" + data.clubs.irons["carlsgolfland.com"] + '.txt',
  "../../../web-src-scraping/clubs/irons/" + data.clubs.irons["dickssportinggoods.com"] + '.txt'
];
