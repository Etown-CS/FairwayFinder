...
const filePaths = [
  "../../../web-src-scraping/clubs/putters/" + data.clubs.putters["tgw.com"] + '.txt',
  "../../../web-src-scraping/clubs/putters/" + data.clubs.putters["rockbottomgolf.com"] + '.txt',
  "../../../web-src-scraping/clubs/putters/" + data.clubs.putters["globalgolf.com"] + '.txt',
  "../../../web-src-scraping/clubs/putters/" + data.clubs.putters["pgatoursuperstore.com"] + '.txt',
  "../../../web-src-scraping/clubs/putters/" + data.clubs.putters["golfdiscount.com"] + '.txt',
  "../../../web-src-scraping/clubs/putters/" + data.clubs.putters["carlsgolfland.com"] + '.txt',
  "../../../web-src-scraping/clubs/putters/" + data.clubs.putters["dickssportinggoods.com"] + '.txt'
];
