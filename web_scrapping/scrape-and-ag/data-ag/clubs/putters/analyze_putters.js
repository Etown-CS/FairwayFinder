...
const filePaths = [
  "../../../web-src-scraping/clubs/putters/" + names.clubs.putters["tgw.com"] + '.txt',
  "../../../web-src-scraping/clubs/putters/" + names.clubs.putters["rockbottomgolf.com"] + '.txt',
  "../../../web-src-scraping/clubs/putters/" + names.clubs.putters["globalgolf.com"] + '.txt',
  "../../../web-src-scraping/clubs/putters/" + names.clubs.putters["pgatoursuperstore.com"] + '.txt',
  "../../../web-src-scraping/clubs/putters/" + names.clubs.putters["golfdiscount.com"] + '.txt',
  "../../../web-src-scraping/clubs/putters/" + names.clubs.putters["carlsgolfland.com"] + '.txt',
  "../../../web-src-scraping/clubs/putters/" + names.clubs.putters["dickssportinggoods.com"] + '.txt'
];
