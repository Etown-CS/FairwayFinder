...
const question = "What are the prices for the products and the site they are from? formatting must be as follows including square brackets and bold tags: Brand: <b>[Brand]</b> Title: <b>[Title]</b> Price: <b>[Price]</b>, at the end of the list add Website: <b>[Website]</b>. If price is not given like click for low price or add to cart for price do no include that product in the list";

// Define the file paths here (replace with your actual file paths)
const filePaths = [
  "../../../web-src-scraping/gloves/left/women/gloves_women_left-1.txt",
  "../../../web-src-scraping/gloves/left/women/gloves_women_left-2.txt",
  "../../../web-src-scraping/gloves/left/women/gloves_women_left-3.txt",
  "../../../web-src-scraping/gloves/left/women/gloves_women_left-4.txt",
  "../../../web-src-scraping/gloves/left/women/gloves_women_left-5.txt",
  "../../../web-src-scraping/gloves/left/women/gloves_women_left-6.txt",
];
