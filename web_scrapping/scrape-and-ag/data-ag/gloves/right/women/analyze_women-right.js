...
const filePaths = [
  "../../../../web-src-scraping/gloves/right/women/" + data.gloves.right.women["tgw.com"] + '.txt',
  "../../../../web-src-scraping/gloves/right/women/" + data.gloves.right.women["rockbottomgolf.com"] + '.txt',
  "../../../../web-src-scraping/gloves/right/women/" + data.gloves.right.women["pgatoursuperstore.com"] + '.txt',
  "../../../../web-src-scraping/gloves/right/women/" + data.gloves.right.women["golfdiscount.com"] + '.txt',
  "../../../../web-src-scraping/gloves/right/women/" + data.gloves.right.women["dickssportinggoods.com"] + '.txt'
