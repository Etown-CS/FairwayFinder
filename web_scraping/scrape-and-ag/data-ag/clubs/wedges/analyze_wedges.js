...
const filePaths = [
  "../../../ocr/clubs/wedges/" + names.clubs.wedges["tgw.com"] + '.txt',
  "../../../ocr/clubs/wedges/" + names.clubs.wedges["rockbottomgolf.com"] + '.txt',
  "../../../ocr/clubs/wedges/" + names.clubs.wedges["globalgolf.com"] + '.txt',
  "../../../ocr/clubs/wedges/" + names.clubs.wedges["pgatoursuperstore.com"] + '.txt',
  "../../../ocr/clubs/wedges/" + names.clubs.wedges["golfdiscount.com"] + '.txt',
  "../../../ocr/clubs/wedges/" + names.clubs.wedges["carlsgolfland.com"] + '.txt',
  "../../../ocr/clubs/wedges/" + names.clubs.wedges["dickssportinggoods.com"] + '.txt'
];
