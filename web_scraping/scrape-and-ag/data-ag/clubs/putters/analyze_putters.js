...
const filePaths = [
  "../../../ocr/clubs/putters/" + names.clubs.putters["tgw.com"] + '.txt',
  "../../../ocr/clubs/putters/" + names.clubs.putters["rockbottomgolf.com"] + '.txt',
  "../../../ocr/clubs/putters/" + names.clubs.putters["globalgolf.com"] + '.txt',
  "../../../ocr/clubs/putters/" + names.clubs.putters["pgatoursuperstore.com"] + '.txt',
  "../../../ocr/clubs/putters/" + names.clubs.putters["golfdiscount.com"] + '.txt',
  "../../../ocr/clubs/putters/" + names.clubs.putters["carlsgolfland.com"] + '.txt',
  "../../../ocr/clubs/putters/" + names.clubs.putters["dickssportinggoods.com"] + '.txt'
];
