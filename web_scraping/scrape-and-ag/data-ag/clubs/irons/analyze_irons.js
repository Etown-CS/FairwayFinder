...
const filePaths = [
  "../../../ocr/clubs/irons/" + names.clubs.irons["tgw.com"] + '.txt',
  "../../../ocr/clubs/irons/" + names.clubs.irons["rockbottomgolf.com"] + '.txt',
  "../../../ocr/clubs/irons/" + names.clubs.irons["globalgolf.com"] + '.txt',
  "../../../ocr/clubs/irons/" + names.clubs.irons["pgatoursuperstore.com"] + '.txt',
  "../../../ocr/clubs/irons/" + names.clubs.irons["golfdiscount.com"] + '.txt',
  "../../../ocr/clubs/irons/" + names.clubs.irons["carlsgolfland.com"] + '.txt',
  "../../../ocr/clubs/irons/" + names.clubs.irons["dickssportinggoods.com"] + '.txt'
];
