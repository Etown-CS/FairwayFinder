...
const filePaths = [
  "../../../ocr/clubs/hybrids/" + names.clubs.hybrids["tgw.com"] + '.txt',
  "../../../ocr/clubs/hybrids/" + names.clubs.hybrids["rockbottomgolf.com"] + '.txt',
  "../../../ocr/clubs/hybrids/" + names.clubs.hybrids["globalgolf.com"] + '.txt',
  "../../../ocr/clubs/hybrids/" + names.clubs.hybrids["pgatoursuperstore.com"] + '.txt', 
  "../../../ocr/clubs/hybrids/" + names.clubs.hybrids["golfdiscount.com"] + '.txt',
  "../../../ocr/clubs/hybrids/" + names.clubs.hybrids["carlsgolfland.com"] + '.txt',
  "../../../ocr/clubs/hybrids/" + names.clubs.hybrids["dickssportinggoods.com"] + '.txt'
];
