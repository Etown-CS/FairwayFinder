...
const filePaths = [
  "../../../ocr/clubs/drivers/" + names.clubs.drivers["tgw.com"] + '.txt',
  "../../../ocr/clubs/drivers/" + names.clubs.drivers["rockbottomgolf.com"] + '.txt',
  "../../../ocr/clubs/drivers/" + names.clubs.drivers["globalgolf.com"] + '.txt',
  "../../../ocr/clubs/drivers/" + names.clubs.drivers["pgatoursuperstore.com"] + '.txt',
  "../../../ocr/clubs/drivers/" + names.clubs.drivers["golfdiscount.com"] + '.txt',
  "../../../ocr/clubs/drivers/" + names.clubs.drivers["carlsgolfland.com"] + '.txt',
  "../../../ocr/clubs/drivers/" + names.clubs.drivers["dickssportinggoods.com"] + '.txt'
];
