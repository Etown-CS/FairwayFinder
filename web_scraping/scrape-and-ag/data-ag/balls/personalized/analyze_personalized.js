...
const filePaths = [
  "../../../ocr/balls/personalized/" + names.balls.personalized["tgw.com"] + '.txt',
  "../../../ocr/balls/personalized/" + names.balls.personalized["rockbottomgolf.com"] + '.txt',
  "../../../ocr/balls/personalized/" + names.balls.personalized["globalgolf.com"] + '.txt',
  "../../../ocr/balls/personalized/" + names.balls.personalized["pgatoursuperstore.com"] + '.txt',
  "../../../ocr/balls/personalized/" + names.balls.personalized["golfdiscount.com"] + '.txt',
  "../../../ocr/balls/personalized/" + names.balls.personalized["carlsgolfland.com"] + '.txt',
  "../../../ocr/balls/personalized/" + names.balls.personalized["dickssportinggoods.com"] + '.txt'
];
