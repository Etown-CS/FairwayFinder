...
const filePaths = [
  "../../../ocr/balls/all/" + names.balls.all["tgw.com"] + '.txt',
  "../../../ocr/balls/all/" + names.balls.all["rockbottomgolf.com"] + '.txt',
  "../../../ocr/balls/all/" + names.balls.all["globalgolf.com"] + '.txt',
  "../../../ocr/balls/all/" + names.balls.all["pgatoursuperstore.com"] + '.txt',
  "../../../ocr/balls/all/" + names.balls.all["golfdiscount.com"] + '.txt',
  "../../../ocr/balls/all/" + names.balls.all["carlsgolfland.com"] + '.txt',
  "../../../ocr/balls/all/" + names.balls.all["dickssportinggoods.com"] + '.txt'
];
