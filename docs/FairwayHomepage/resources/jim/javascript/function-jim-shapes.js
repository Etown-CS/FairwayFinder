                ...
                if(!$shape.is(".line")){
                  ...
                  style = {
                      "attributes" : {
                          ...
                          "min-height" : $(mainDiv).is(".autofit") ? 0 : parseFloat(shapeSVG.css2svg["original-height"])
                  }};
                }else {
        ...
        "translateCSSChanges" : function(shapeSVG, style) {
            ...
            if (style.attributes) {
                ...
                if (style.attributes['width'] != null || style.attributes['min-height'] != null) {
				  ...
				  var oldHeight = shapeSVG.css2svg['min-height'];
				  ...
				  var nonTextBoxHeight = oldHeight != undefined ? ((parseFloat(style.attributes['min-height']) / oldHeight) * nonTextboxSize.height) : nonTextboxSize.height;
                  var minTextHeight = parseFloat($(shapeSVG).shapeStyle("min-height")) - parseInt($(shapeSVG).shapeStyle("padding-top")) - parseInt($(shapeSVG).shapeStyle("padding-bottom")) - nonTextBoxHeight -(borderTextPadding*2);
