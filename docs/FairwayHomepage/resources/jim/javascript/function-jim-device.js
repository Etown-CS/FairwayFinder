...
(function(window, undefined) {
	  ...
	  var jimDevice = {
		 ...
		 "isAndroidNamed" : function() {
			 if(jimDevice.isAndroidGalaxy() || jimDevice.isAndroidPixel())
				 return true;
			 return false;
		 },
		 "isAndroidGalaxy" : function() {
			 if(jimDevice.name.toLowerCase().indexOf("galaxy")>=0)
				 return true;
			 return false;
		 },
		 "isAndroidPixel" : function() {
			 if(jimDevice.name.toLowerCase().indexOf("pixel")>=0)
				 return true;
			 return false;
		 },
